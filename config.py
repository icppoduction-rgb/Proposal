...
STAGE_TWO_PACKET_BATCH_SIZE: int = 50_000
STAGE_TWO_DEFAULT_BATCH_SIZE: int = 50_000
STAGE_TWO_MAX_OUTPUT_PART_ROWS: int = 50_000
STAGE_TWO_DEFAULT_WORKERS: int = 1
...
manage_commands: str = (
    ...
    "python manage.py stage-three build-model-ready --experiment-id exp001 --branch dns --resume\n"
    ...
    "python manage.py stage-three trace-artifact <feature_or_model_ready_artifact_ref>\n"
