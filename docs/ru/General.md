# General.md: полный контекст проекта Proposal

Файл собран как единая база знаний из всех Markdown-документов `docs/ru/**/*.md`. Он предназначен для использования как полный контекст проекта при дальнейшей разработке, ревью и работе с Codex.

Исходные `.md` файлы не удалялись и не перезаписывались. Внутри каждого блока указан источник, а содержательные разделы исходных документов сохранены полностью; заголовки понижены только для единой структуры `General.md`. Относительные Markdown-ссылки из вложенных документов пересчитаны так, чтобы они работали из `docs/ru/General.md`.

- Дата сборки: 2026-06-23.
- Количество исходных Markdown-файлов: 46.
- Язык: русский.

## Принципы объединения

1. Сохранены таблицы, команды, Mermaid-схемы, JSON/CLI examples, статусы, пути, ограничения, риски и рекомендации.
2. Явные повторы не удалялись из source-by-source блоков, если они помогают сохранить контекст и происхождение информации.
3. Если похожие сведения отличаются деталями, оба варианта сохранены в соответствующих источниках.
4. `TRAIN`, `VALIDATION` и `TEST` не смешиваются; исходные разделы сохраняют разделение ролей.
5. Фактическая реализация, proposal/research материалы и gaps вынесены в разные логические блоки и сохраняют исходные формулировки.

## Противоречия и вопросы для проверки

При сборке не выявлено новых неразрешенных противоречий, требующих исправления в `General.md`. Зафиксированные различия в исходных документах сохранены как часть контекста:

- [repository_state_qa_and_gaps.md](repository_state_qa_and_gaps.md) указывает историческое значение `Host filtered kept paths: 361646` из старого QA и актуальную сводку `361675 total files` по `analysis-dataset`; сам документ уже объясняет это как старый QA показатель против актуальной сводки.
- Разделы `feature/model-ready` частично описаны как contracts/writers/registry services и proposal/follow-up: [normalization/README.md](normalization/README.md), [repository_state_qa_and_gaps.md](repository_state_qa_and_gaps.md) и [feature_extraction_and_catalogue.md](feature_extraction_and_catalogue.md) явно отделяют реализованный CLI normalization от будущих ML/model build шагов.

## Источники

### Обзор проекта, research context и верхнеуровневая навигация

- `README.md`
- `project_documentation_index.md`
- `project_overview_and_research_context.md`
- `repository_state_qa_and_gaps.md`
- `dataset_strategy_dns_host.md`
- `feature_extraction_and_catalogue.md`

### Datasets analysis: DNS, Host, labels и readiness

- `analysis-dataset/README.md`
- `analysis-dataset/dns_datasets.md`
- `analysis-dataset/host_datasets.md`
- `analysis-dataset/format_status_matrix.md`
- `analysis-dataset/labels_and_readiness.md`
- `analysis-dataset/parser_feature_recommendations.md`
- `analysis-dataset/source_inventory.md`

### Stage Two / normalization: запуск, storage, parsers, artifacts и checks

- `normalization/README.md`
- `normalization/usage_guide.md`
- `normalization/stage_two_commands.md`
- `normalization/storage_architecture.md`
- `normalization/postgresql_catalog_schema.md`
- `normalization/normalized_event_schema.md`
- `normalization/parser_strategy.md`
- `normalization/parser_development_guide.md`
- `normalization/label_resolver.md`
- `normalization/parquet_duckdb_artifacts.md`
- `normalization/data_quality_checks.md`
- `normalization/data_leakage_prevention.md`
- `normalization/traceability.md`
- `normalization/performance_tuning.md`
- `normalization/runtime_resource_runbook.md`
- `normalization/final_summary_template.md`

### Code architecture: CLI, Stage One handlers, Stage Two, DB, schemas и extension points

- `code-documentation/README.md`
- `code-documentation/cli_and_routing.md`
- `code-documentation/stage_one_handlers.md`
- `code-documentation/stage_two_overview.md`
- `code-documentation/storage_architecture.md`
- `code-documentation/postgresql_catalog.md`
- `code-documentation/sqlalchemy_layer.md`
- `code-documentation/normalized_event_schema.md`
- `code-documentation/parser_strategy.md`
- `code-documentation/label_resolver.md`
- `code-documentation/parquet_and_duckdb.md`
- `code-documentation/data_quality_checks.md`
- `code-documentation/data_leakage_prevention.md`
- `code-documentation/traceability.md`
- `code-documentation/dataset_contracts.md`
- `code-documentation/extension_points.md`
- `code-documentation/risks_and_technical_debt.md`

## 1. Обзор проекта, research context и верхнеуровневая навигация

Объединяет общую карту документации, research/proposal context, границы фактической реализации, dataset strategy и feature catalogue.

### Источник: `README.md`

Оригинальный файл: [README.md](README.md)
...
### Источник: `project_documentation_index.md`

Оригинальный файл: [project_documentation_index.md](project_documentation_index.md)
...
### Источник: `project_overview_and_research_context.md`

Оригинальный файл: [project_overview_and_research_context.md](project_overview_and_research_context.md)
...
### Источник: `repository_state_qa_and_gaps.md`

Оригинальный файл: [repository_state_qa_and_gaps.md](repository_state_qa_and_gaps.md)
...
### Источник: `dataset_strategy_dns_host.md`

Оригинальный файл: [dataset_strategy_dns_host.md](dataset_strategy_dns_host.md)
...
### Источник: `feature_extraction_and_catalogue.md`

Оригинальный файл: [feature_extraction_and_catalogue.md](feature_extraction_and_catalogue.md)
...
## 2. Datasets analysis: DNS, Host, labels и readiness

Содержит Stage One результаты анализа датасетов, counts, format buckets, статусы готовности, labels и рекомендации для parser/feature extraction.

### Источник: `analysis-dataset/README.md`

Оригинальный файл: [analysis-dataset/README.md](analysis-dataset/README.md)
...
| Документ | Назначение |
| --- | --- |
| [dns_datasets.md](analysis-dataset/dns_datasets.md) | DNS TRAIN/VALIDATION/TEST: форматы, количество файлов, labels, timestamp/readiness, parser notes. |
| [host_datasets.md](analysis-dataset/host_datasets.md) | Host TRAIN/VALIDATION/TEST: семейства данных, количество файлов, quality risks, parser notes. |
| [format_status_matrix.md](analysis-dataset/format_status_matrix.md) | Единая таблица 66 format buckets со статусом readiness и ключевыми фактами. |
| [labels_and_readiness.md](analysis-dataset/labels_and_readiness.md) | Label availability, canonical label rules, readiness statuses и anti-leakage правила. |
| [parser_feature_recommendations.md](analysis-dataset/parser_feature_recommendations.md) | Рекомендации для Stage Two parser implementations и feature extraction. |
| [source_inventory.md](analysis-dataset/source_inventory.md) | Индекс старых файлов, которые были объединены в новую структуру. |
...
### Источник: `analysis-dataset/dns_datasets.md`

Оригинальный файл: [analysis-dataset/dns_datasets.md](analysis-dataset/dns_datasets.md)
...
### Источник: `analysis-dataset/host_datasets.md`

Оригинальный файл: [analysis-dataset/host_datasets.md](analysis-dataset/host_datasets.md)
...
### Источник: `analysis-dataset/format_status_matrix.md`

Оригинальный файл: [analysis-dataset/format_status_matrix.md](analysis-dataset/format_status_matrix.md)

#### Матрица форматов и статусов

Матрица сохраняет ключевые данные из 66 старых per-format отчетов: split, format, число файлов, readiness, label availability, timestamp availability и основное ограничение. Полные старые пути перечислены в [source_inventory.md](analysis-dataset/source_inventory.md).
...
### Источник: `analysis-dataset/labels_and_readiness.md`

Оригинальный файл: [analysis-dataset/labels_and_readiness.md](analysis-dataset/labels_and_readiness.md)
...
### Источник: `analysis-dataset/parser_feature_recommendations.md`

Оригинальный файл: [analysis-dataset/parser_feature_recommendations.md](analysis-dataset/parser_feature_recommendations.md)
...
### Источник: `analysis-dataset/source_inventory.md`

Оригинальный файл: [analysis-dataset/source_inventory.md](analysis-dataset/source_inventory.md)
...
| --- | --- |
| [README.md](analysis-dataset/README.md) | Общая карта раздела, coverage, readiness counts, инварианты. |
| [dns_datasets.md](analysis-dataset/dns_datasets.md) | Все DNS TRAIN/VALIDATION/TEST сведения. |
| [host_datasets.md](analysis-dataset/host_datasets.md) | Все Host TRAIN/VALIDATION/TEST сведения. |
| [format_status_matrix.md](analysis-dataset/format_status_matrix.md) | 66 format buckets: files/status/labels/timestamp/action. |
| [labels_and_readiness.md](analysis-dataset/labels_and_readiness.md) | Label policy, readiness statuses, LabelResolver guidance. |
| [parser_feature_recommendations.md](analysis-dataset/parser_feature_recommendations.md) | Parser priorities, feature groups, quality checks. |
...
## 3. Stage Two / normalization: запуск, storage, parsers, artifacts и checks

Содержит операционную документацию Stage Two: CLI-команды, storage, PostgreSQL Catalog, parser registry, normalized schema, labels, Parquet/DuckDB, quality/leakage checks, traceability, performance и runbooks.

### Источник: `normalization/README.md`

Оригинальный файл: [normalization/README.md](normalization/README.md)
...
| --- | --- | --- |
| CLI/routing | `manage.py`, `scripts/router_script.py`, `scripts/stage_two/cli.py` | [usage_guide.md](normalization/usage_guide.md), [stage_two_commands.md](normalization/stage_two_commands.md) |
| Storage bootstrap | `scripts/stage_two/storage/bootstrap.py` | [storage_architecture.md](normalization/storage_architecture.md) |
| Catalog ingestion | `scripts/stage_two/ingestion/*` | [postgresql_catalog_schema.md](normalization/postgresql_catalog_schema.md) |
| Parser registry/resolver | `scripts/stage_two/parser_registry/*` | [parser_strategy.md](normalization/parser_strategy.md) |
| Parser development | `scripts/stage_two/parsers/*` | [parser_development_guide.md](normalization/parser_development_guide.md) |
| Label resolver | `scripts/stage_two/labels/resolver.py` | [label_resolver.md](normalization/label_resolver.md) |
| Normalized schema | `schemas/normalized/normalized_event_v1.json` | [normalized_event_schema.md](normalization/normalized_event_schema.md) |
| Parquet/DuckDB | `scripts/stage_two/parquet/*`, `scripts/stage_two/duckdb/*` | [parquet_duckdb_artifacts.md](normalization/parquet_duckdb_artifacts.md) |
| Quality checks | `scripts/stage_two/quality/checkers.py` | [data_quality_checks.md](normalization/data_quality_checks.md) |
| Leakage prevention | feature/model-ready contracts, `LeakageChecker` | [data_leakage_prevention.md](normalization/data_leakage_prevention.md) |
| Traceability | `scripts/stage_two/traceability/service.py` | [traceability.md](normalization/traceability.md) |
| Performance/runbooks | normalization options, large-file split, recovery steps | [performance_tuning.md](normalization/performance_tuning.md), [runtime_resource_runbook.md](normalization/runtime_resource_runbook.md) |
...
1. [usage_guide.md](normalization/usage_guide.md) - как запустить Stage Two и какие команды реально поддерживает CLI.
2. [stage_two_commands.md](normalization/stage_two_commands.md) - полный reference по командам normalization: входы, выходы, статусы, ошибки и проверки.
3. [storage_architecture.md](normalization/storage_architecture.md) - что должно быть в `PATH_DATA_STORAGE`.
4. [postgresql_catalog_schema.md](normalization/postgresql_catalog_schema.md) - какие metadata и связи хранятся в PostgreSQL.
5. [parser_strategy.md](normalization/parser_strategy.md) и [parser_development_guide.md](normalization/parser_development_guide.md) - как выбирается parser и как добавить новый.
6. [normalized_event_schema.md](normalization/normalized_event_schema.md) и [label_resolver.md](normalization/label_resolver.md) - контракт normalized event и правила labels.
7. [parquet_duckdb_artifacts.md](normalization/parquet_duckdb_artifacts.md), [data_quality_checks.md](normalization/data_quality_checks.md), [data_leakage_prevention.md](normalization/data_leakage_prevention.md), [traceability.md](normalization/traceability.md) - артефакты, проверки и lineage.
8. [performance_tuning.md](normalization/performance_tuning.md), [runtime_resource_runbook.md](normalization/runtime_resource_runbook.md), [final_summary_template.md](normalization/final_summary_template.md) - эксплуатация, восстановление и итоговая отчетность.
...
### Источник: `normalization/usage_guide.md`

Оригинальный файл: [normalization/usage_guide.md](normalization/usage_guide.md)
...
Полный reference по каждой Stage Two normalization команде, включая входы, выходы, статусы PostgreSQL, ошибки и проверки, находится в [stage_two_commands.md](normalization/stage_two_commands.md).
...
### Источник: `normalization/stage_two_commands.md`

Оригинальный файл: [normalization/stage_two_commands.md](normalization/stage_two_commands.md)
...
| 9 | `normalize-dns [limit]` | Да | Legacy shortcut для DNS files со статусом `READY_FOR_PARSING`. |
| 10 | `normalize-host [limit]` | Да | Legacy shortcut для Host files со статусом `READY_FOR_PARSING`. |
| 11 | `run-duckdb-checks` | Да | Создать DuckDB views и записать analytics report. |
| 12 | `run-leakage-checks` | Да | Проверить model-ready/feature contracts на leakage. |
| 13 | `trace-artifact` | Да | Восстановить lineage для model-ready artifact. |
...
### Источник: `normalization/storage_architecture.md`

Оригинальный файл: [normalization/storage_architecture.md](normalization/storage_architecture.md)
...
### Источник: `normalization/postgresql_catalog_schema.md`

Оригинальный файл: [normalization/postgresql_catalog_schema.md](normalization/postgresql_catalog_schema.md)
...
### Источник: `normalization/normalized_event_schema.md`

Оригинальный файл: [normalization/normalized_event_schema.md](normalization/normalized_event_schema.md)
...
### Источник: `normalization/parser_strategy.md`

Оригинальный файл: [normalization/parser_strategy.md](normalization/parser_strategy.md)
...
### Источник: `normalization/parser_development_guide.md`

Оригинальный файл: [normalization/parser_development_guide.md](normalization/parser_development_guide.md)
...
Обязательные поля перечислены в [normalized_event_schema.md](normalization/normalized_event_schema.md).
...
См. [label_resolver.md](normalization/label_resolver.md).
...
### Источник: `normalization/label_resolver.md`

Оригинальный файл: [normalization/label_resolver.md](normalization/label_resolver.md)
...
### Источник: `normalization/parquet_duckdb_artifacts.md`

Оригинальный файл: [normalization/parquet_duckdb_artifacts.md](normalization/parquet_duckdb_artifacts.md)
...
### Источник: `normalization/data_quality_checks.md`

Оригинальный файл: [normalization/data_quality_checks.md](normalization/data_quality_checks.md)
...
`LeakageChecker` находится в том же модуле, но описан отдельно в [data_leakage_prevention.md](normalization/data_leakage_prevention.md). Его CRITICAL results также регистрируются в `data_quality_reports`, обычно с `check_group = "leakage"`.
...
### Источник: `normalization/data_leakage_prevention.md`

Оригинальный файл: [normalization/data_leakage_prevention.md](normalization/data_leakage_prevention.md)
...
### Источник: `normalization/traceability.md`

Оригинальный файл: [normalization/traceability.md](normalization/traceability.md)
...
### Источник: `normalization/performance_tuning.md`

Оригинальный файл: [normalization/performance_tuning.md](normalization/performance_tuning.md)
...
### Источник: `normalization/runtime_resource_runbook.md`

Оригинальный файл: [normalization/runtime_resource_runbook.md](normalization/runtime_resource_runbook.md)
...
### Источник: `normalization/final_summary_template.md`

Оригинальный файл: [normalization/final_summary_template.md](normalization/final_summary_template.md)
...
## 4. Code architecture: CLI, Stage One handlers, Stage Two, DB, schemas и extension points

Содержит техническую документацию по коду: routing, handlers, Stage Two services, PostgreSQL/SQLAlchemy, normalized schema, parsers, labels, Parquet/DuckDB, quality/leakage, traceability, dataset contracts, risks и extension points.

### Источник: `code-documentation/README.md`

Оригинальный файл: [code-documentation/README.md](code-documentation/README.md)
...
| Документ | Назначение |
|---|---|
| [cli_and_routing.md](code-documentation/cli_and_routing.md) | `manage.py`, слой маршрутизации, команды Stage One/Stage Two, порядок запуска |
| [stage_one_handlers.md](code-documentation/stage_one_handlers.md) | handlers Stage One: анализ, фильтрация, сортировка, экспорт путей, анализ содержимого, JSON |
| [stage_two_overview.md](code-documentation/stage_two_overview.md) | pipeline Stage Two: storage, ingestion, registry, normalization, checks |
| [storage_architecture.md](code-documentation/storage_architecture.md) | `PATH_DATA_STORAGE`, обязательные директории, пути артефактов |
| [postgresql_catalog.md](code-documentation/postgresql_catalog.md) | таблицы PostgreSQL catalog и цепочка трассируемости |
| [sqlalchemy_layer.md](code-documentation/sqlalchemy_layer.md) | config/session/models/repositories/migrations/smoke check |
| [normalized_event_schema.md](code-documentation/normalized_event_schema.md) | `normalized_event_v1`, поля, timestamp, labels, traceability |
| [parser_strategy.md](code-documentation/parser_strategy.md) | parser registry, resolver, parser classes, статусы parser runs |
| [label_resolver.md](code-documentation/label_resolver.md) | источники labels, ограничения TEST, конфликтные labels |
| [parquet_and_duckdb.md](code-documentation/parquet_and_duckdb.md) | Parquet writer, пути, compression, DuckDB views/checks |
| [data_quality_checks.md](code-documentation/data_quality_checks.md) | DataQualityChecker, DuckDB analytics, отчеты |
| [data_leakage_prevention.md](code-documentation/data_leakage_prevention.md) | запрещенные X-колонки, инварианты TRAIN/VALIDATION/TEST |
| [traceability.md](code-documentation/traceability.md) | цепочка raw -> normalized -> features -> model-ready |
| [dataset_contracts.md](code-documentation/dataset_contracts.md) | DNS/Host TRAIN/VALIDATION/TEST форматы, количества, labels, потребности parser |
| [extension_points.md](code-documentation/extension_points.md) | как добавлять handlers, parsers, schemas, labels, checks, stages |
| [risks_and_technical_debt.md](code-documentation/risks_and_technical_debt.md) | известные ограничения, parser gaps, риски leakage/timestamp/large files |

##### Рекомендуемый порядок чтения

1. [cli_and_routing.md](code-documentation/cli_and_routing.md)
2. [stage_one_handlers.md](code-documentation/stage_one_handlers.md)
3. [stage_two_overview.md](code-documentation/stage_two_overview.md)
4. [postgresql_catalog.md](code-documentation/postgresql_catalog.md)
5. [normalized_event_schema.md](code-documentation/normalized_event_schema.md)
6. [parser_strategy.md](code-documentation/parser_strategy.md)
7. [label_resolver.md](code-documentation/label_resolver.md)
8. [data_leakage_prevention.md](code-documentation/data_leakage_prevention.md)
9. [dataset_contracts.md](code-documentation/dataset_contracts.md)
10. [risks_and_technical_debt.md](code-documentation/risks_and_technical_debt.md)
...
Подробные аргументы и порядок запуска описаны в [cli_and_routing.md](code-documentation/cli_and_routing.md).

### Источник: `code-documentation/cli_and_routing.md`

Оригинальный файл: [code-documentation/cli_and_routing.md](code-documentation/cli_and_routing.md)
...
### Источник: `code-documentation/stage_one_handlers.md`

Оригинальный файл: [code-documentation/stage_one_handlers.md](code-documentation/stage_one_handlers.md)
...
### Источник: `code-documentation/stage_two_overview.md`

Оригинальный файл: [code-documentation/stage_two_overview.md](code-documentation/stage_two_overview.md)
...
### Источник: `code-documentation/storage_architecture.md`

Оригинальный файл: [code-documentation/storage_architecture.md](code-documentation/storage_architecture.md)
...
### Источник: `code-documentation/postgresql_catalog.md`

Оригинальный файл: [code-documentation/postgresql_catalog.md](code-documentation/postgresql_catalog.md)
...
### Источник: `code-documentation/sqlalchemy_layer.md`

Оригинальный файл: [code-documentation/sqlalchemy_layer.md](code-documentation/sqlalchemy_layer.md)
...
### Источник: `code-documentation/normalized_event_schema.md`

Оригинальный файл: [code-documentation/normalized_event_schema.md](code-documentation/normalized_event_schema.md)
...
### Источник: `code-documentation/parser_strategy.md`

Оригинальный файл: [code-documentation/parser_strategy.md](code-documentation/parser_strategy.md)
...
### Источник: `code-documentation/label_resolver.md`

Оригинальный файл: [code-documentation/label_resolver.md](code-documentation/label_resolver.md)
...
### Источник: `code-documentation/parquet_and_duckdb.md`

Оригинальный файл: [code-documentation/parquet_and_duckdb.md](code-documentation/parquet_and_duckdb.md)
...
### Источник: `code-documentation/data_quality_checks.md`

Оригинальный файл: [code-documentation/data_quality_checks.md](code-documentation/data_quality_checks.md)
...
Подробности leakage описаны в [data_leakage_prevention.md](code-documentation/data_leakage_prevention.md). Checker пишет:
...
### Источник: `code-documentation/data_leakage_prevention.md`

Оригинальный файл: [code-documentation/data_leakage_prevention.md](code-documentation/data_leakage_prevention.md)
...
### Источник: `code-documentation/traceability.md`

Оригинальный файл: [code-documentation/traceability.md](code-documentation/traceability.md)
...
### Источник: `code-documentation/dataset_contracts.md`

Оригинальный файл: [code-documentation/dataset_contracts.md](code-documentation/dataset_contracts.md)
...
### Источник: `code-documentation/extension_points.md`

Оригинальный файл: [code-documentation/extension_points.md](code-documentation/extension_points.md)
...
### Источник: `code-documentation/risks_and_technical_debt.md`

Оригинальный файл: [code-documentation/risks_and_technical_debt.md](code-documentation/risks_and_technical_debt.md)
