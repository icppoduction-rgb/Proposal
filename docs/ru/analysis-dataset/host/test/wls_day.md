...
## 3. Примеры файлов
```text
C:\Users\fmark\PythonProjects\storages\datasets-filter\host\TEST\wls_day\wls_day-01
C:\Users\fmark\PythonProjects\storages\datasets-filter\host\TEST\wls_day\wls_day-57
C:\Users\fmark\PythonProjects\storages\datasets-filter\host\TEST\wls_day\wls_day-85
```
