...
The current CLI has normalization and check commands. A full feature/model-ready build CLI step is not implemented; that layer currently exists as contracts/writers/registry services.
