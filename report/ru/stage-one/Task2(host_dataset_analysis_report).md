...
Реализован первый этап анализа Host-датасетов: поиск файлов в директории Host-датасетов, распределение по ролям (`TRAIN`, `TEST`, `VALIDATION`) и сохранение структуры в JSON.
