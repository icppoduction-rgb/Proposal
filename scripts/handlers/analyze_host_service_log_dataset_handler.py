...
"""
    ...
    def _build_ru_report(self, summary_payload: dict[str, Any], summary_json_path: Path) -> str:
        ...
        return (
            ...
            "- `PATH_REPORT/ru/stage-one/analysis-dataset/host/Task33(Analysis of host service-log dataset files)_report.md`\n"
            "- `PATH_REPORT/en/stage-one/analysis-dataset/host/Task33(Analysis of host service-log dataset files)_report.md`\n"
