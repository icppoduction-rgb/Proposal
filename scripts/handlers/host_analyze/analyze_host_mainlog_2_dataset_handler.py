...
"""
    ...
    def _build_ru_report(self, summary_payload: dict[str, Any], summary_json_path: Path) -> str:
        ...
        return (
            "# Отчёт: Task22 (Analysis of host mainlog-2 dataset files)\n\n"
            "## Описание задачи\n"
            "Переделан этап анализа `TRAIN/mainlog-2` с генерацией RU/EN-документации и обновлением README индексов.\n\n"
            ...
            "- `PATH_REPORT/ru/stage-one/analysis-dataset/host/Task22(Analysis of host mainlog-2 dataset files)_report.md`\n"
            "- `PATH_REPORT/en/stage-one/analysis-dataset/host/Task22(Analysis of host mainlog-2 dataset files)_report.md`\n"
            ...
            "2. Выбран bucket `TRAIN -> mainlog-2`.\n"
