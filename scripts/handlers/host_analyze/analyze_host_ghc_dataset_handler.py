...
- `PATH_REPORT/ru/stage-one/analysis-dataset/host/Task7(Analysis of host ghc dataset files)_report.md`
- `PATH_REPORT/en/stage-one/analysis-dataset/host/Task7(Analysis of host ghc dataset files)_report.md`
