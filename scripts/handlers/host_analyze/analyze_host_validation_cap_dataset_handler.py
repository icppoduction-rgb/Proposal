...
- `PATH_REPORT/ru/stage-one/analysis-dataset/host/validation/Task1(Analysis of host validation cap dataset files)_report.md`
- `PATH_REPORT/en/stage-one/analysis-dataset/host/validation/Task1(Analysis of host validation cap dataset files)_report.md`
