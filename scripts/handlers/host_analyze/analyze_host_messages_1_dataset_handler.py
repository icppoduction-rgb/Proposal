...
"""
    ...
    def _build_ru_report(self, summary_payload: dict[str, Any], summary_json_path: Path) -> str:
        ...
        return (
            ...
            "- `PATH_REPORT/ru/stage-one/analysis-dataset/host/Task26(Analysis of host messages-1 dataset files)_report.md`\n"
            "- `PATH_REPORT/en/stage-one/analysis-dataset/host/Task26(Analysis of host messages-1 dataset files)_report.md`\n"
