...
"""
    ...
    def _build_ru_report(self, summary_payload: dict[str, Any], summary_json_path: Path) -> str:
        ...
        return (
            "# Отчёт: Task43 (Analysis of host xml dataset files)\n\n"
            "## Описание задачи\n"
            "Переделан этап анализа `TRAIN/xml` с генерацией RU/EN-документации и обновлением README индексов.\n\n"
            ...
            "- `PATH_REPORT/ru/stage-one/analysis-dataset/host/Task43(Analysis of host xml dataset files)_report.md`\n"
            "- `PATH_REPORT/en/stage-one/analysis-dataset/host/Task43(Analysis of host xml dataset files)_report.md`\n"
