...
"""
    ...
    def _build_ru_report(self, summary_payload: dict[str, Any], summary_json_path: Path) -> str:
        ...
        return (
            "# Отчёт: Task13 (Analysis of host load-log dataset files)\n\n"
            "## Описание задачи\n"
            "Переделан этап анализа `TRAIN/load.log` с генерацией RU/EN-документации и обновлением README индексов.\n\n"
            ...
            "- `PATH_REPORT/ru/stage-one/analysis-dataset/host/Task13(Analysis of host load-log dataset files)_report.md`\n"
            "- `PATH_REPORT/en/stage-one/analysis-dataset/host/Task13(Analysis of host load-log dataset files)_report.md`\n"
            ...
            "2. Выбран bucket `TRAIN -> load.log`.\n"
