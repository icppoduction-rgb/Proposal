...
- `PATH_REPORT/ru/stage-one/analysis-dataset/host/test/Task48(Analysis of host test netflow_day dataset files)_report.md`
- `PATH_REPORT/en/stage-one/analysis-dataset/host/test/Task48(Analysis of host test netflow_day dataset files)_report.md`
