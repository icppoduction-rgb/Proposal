...
- `PATH_REPORT/ru/stage-one/analysis-dataset/host/Task6(Analysis of host fsstat-log dataset files)_report.md`
- `PATH_REPORT/en/stage-one/analysis-dataset/host/Task6(Analysis of host fsstat-log dataset files)_report.md`
